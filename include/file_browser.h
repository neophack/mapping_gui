//
// Created by crises on 1/18/20.
//

#ifndef FUSION_MAPPING_INCLUDE_INTERACTIVE_GUI_WIDGET_FILE_BROWSER_H_
#define FUSION_MAPPING_INCLUDE_INTERACTIVE_GUI_WIDGET_FILE_BROWSER_H_
...
class ImGuiFileDialog {
 ...
 public:
  void OpenDialog(const std::string &vKey,
                  ...
                  std::function<void(std::string, bool * )> vOptionsPane,
                  size_t vOptionsPaneWidth = 250,
...
#endif //FUSION_MAPPING_INCLUDE_INTERACTIVE_GUI_WIDGET_FILE_BROWSER_H_
